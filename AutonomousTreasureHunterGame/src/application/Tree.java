...
public class Tree extends SummerObstacle {
	public static int objsize=3;

	public Tree(int mapSize, int[][] mapMatris) {
		super(mapSize, mapMatris, "file:///C:/Users/Sait%20Omer/eclipse-workspace/prolab2projes1/src/Images/Agac.png");
	}
